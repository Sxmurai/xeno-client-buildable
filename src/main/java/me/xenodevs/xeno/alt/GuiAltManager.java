...
public class GuiAltManager extends GuiScreen {
    ...
    private String status = (Object)((Object) TextFormatting.GRAY) + "No alts selected";
    private Mode serviceSwitch = Mode.MOJANG;
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            case 0: {
                ...
                if (!this.loginThread.getStatus().equals((Object)((Object)TextFormatting.YELLOW) + "Attempting to log in") && !this.loginThread.getStatus().equals((Object)((Object)TextFormatting.RED) + "Do not hit back!" + (Object)((Object)TextFormatting.YELLOW) + " Logging in...")) {
                    this.mc.displayGuiScreen(null);
                    break;
                }
                this.loginThread.setStatus((Object)((Object)TextFormatting.RED) + "Failed to login! Please try again!" + (Object)((Object)TextFormatting.YELLOW) + " Logging in...");
                break;
            }
            case 1: {
                String user = this.selectedAlt.getUsername();
                String pass = this.selectedAlt.getPassword();
                int mode = this.selectedAlt.mode;
                this.loginThread = new AltLoginThread(user, pass, mode);
            ...
            case 3: {
                this.mc.displayGuiScreen(new GuiAddAlt(this, serviceSwitch == Mode.MOJANG ? 0 : 1));
                break;
            }
            case 4: {
                this.mc.displayGuiScreen(new GuiAltLogin(this, serviceSwitch.currentMode == Mode.MOJANG ? 0 : 1));
                break;
            }
            ...
            case 7: {
                serviceSwitch.updateService(Mode.MOJANG);
                break;
            }
                
            case 8: {
                serviceSwitch.updateService(Mode.MICROSOFT);
                break;
            }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        RenderUtils2D.drawRect(50.0f, 33.0f, width - 50, height - 50, -16777216);
        GL11.glPushMatrix();
        ...
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                    RenderUtils2D.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2142943931);
                } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                    RenderUtils2D.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2142088622);
                } else {
                    RenderUtils2D.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2144259791);
                }
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                RenderUtils2D.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, 1);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                RenderUtils2D.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, 1);
            }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(8, width - 200, 0, 100, 20, "Use Microsoft"));
        this.login.enabled = false;
        this.remove.enabled = false;
        this.rename.enabled = false;
    }
