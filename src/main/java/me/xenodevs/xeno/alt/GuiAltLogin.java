...
public final class GuiAltLogin extends GuiScreen {
    ...
    public GuiAltLogin(GuiScreen previousScreen, int mode) {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                this.thread = new AltLoginThread(this.username.getText(), this.password.getText(), this.mode);
                this.thread.start();
            }
        }
    }
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        this.drawCenteredString(this.mc.fontRenderer, this.thread == null ? (Object)((Object)TextFormatting.GRAY) + "Idle..." : this.thread.getStatus(), width / 2, 29, -1);
