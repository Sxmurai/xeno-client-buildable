...
public class ColourComponent extends Component {
	...
	public void renderComponent(int mouseX, int mouseY) {
		...
		ClickGui.theme.drawColourPicker(this, op, offset, open, parent, mouseX, mouseY);
	}
	...
	public int getHeight() {
		return (open ? ClickGuiVariables.buttonBarHeight * 7 : ClickGuiVariables.buttonBarHeight);
    }
    ...
    public void doRainbow(int mouseX, int mouseY, int mouseButton) {   	
    	if(mouseButton == 0 && mouseOver((parent.parent.getX()), (parent.parent.getY() + offset + ClickGuiVariables.buttonBarHeight * 6 - 2), (parent.parent.getX() + parent.parent.getWidth()), (parent.parent.getY() + offset + ClickGuiVariables.buttonBarHeight * 7), mouseX, mouseY)) {
