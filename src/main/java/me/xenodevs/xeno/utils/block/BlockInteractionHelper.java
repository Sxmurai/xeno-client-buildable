...
public class BlockInteractionHelper {
    ...
    public static void faceVectorPacketInstant(Vec3d vec) {
        ...
        Wrapper.getConnection().sendPacket(new CPacketPlayer.Rotation(rotations[0],
    ...
    private static void processRightClickBlock(BlockPos pos, EnumFacing side, Vec3d hitVec) {
        getPlayerController().processRightClickBlock((EntityPlayerSP) Wrapper.getPlayer(), mc.world, pos, side, hitVec, EnumHand.MAIN_HAND);
    }
