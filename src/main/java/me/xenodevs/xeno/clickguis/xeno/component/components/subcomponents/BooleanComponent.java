...
public class BooleanComponent extends Component {
	...
	public void renderComponent(int mouseX, int mouseY) {
		TextUtil.drawClickGuiString(op.getName(), parent.parent.getX() + 6, (float) (parent.parent.getY() + offset + 2), parent.parent.getX() + (parent.parent.getWidth() / 2), parent.parent.getX() + parent.parent.getWidth(), op.enabled ? XenoGui.color : -1);
	}
