...
public class StringComponent extends Component {
	...
	public void renderComponent(int mouseX, int mouseY) {
		GL11.glPushMatrix();
		if(isListening) {
			TextUtil.drawStringWithShadow(op.getName() + " " + "\u00a77" + currentString.getString() + "_", parent.parent.getX() + 6, (float) (parent.parent.getY() + offset + 2), -1);
		} else {
			TextUtil.drawStringWithShadow((op.getName() + " " + "\u00a77") + op.getText(), parent.parent.getX() + 6, (float) (parent.parent.getY() + offset + 2), -1);
		}
		GL11.glPopMatrix();
	}
