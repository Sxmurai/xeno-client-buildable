...
public class FontRender extends FontRenderer implements Globals {
    ...
    public void drawRainbowStringWithShadow(String text, float x2, float y2, int color, float speed, float saturation, int seperation) {
        ...
        for(char c : text.toCharArray()) {
            drawStringWithShadow(String.valueOf(c), x2 + off, y2, ColorUtil.rainbowWave(speed, saturation, 1, count));
